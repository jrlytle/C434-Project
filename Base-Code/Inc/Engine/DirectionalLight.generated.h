...
#define Engine_Source_Runtime_Engine_Classes_Engine_DirectionalLight_h_19_INCLASS_NO_PURE_DECLS \
	...
	friend ENGINE_API class UClass* Z_Construct_UClass_ADirectionalLight(); \
	public: \
	DECLARE_CLASS(ADirectionalLight, ALight, COMPILED_IN_FLAGS(0), 0, Engine, ENGINE_API) \
	DECLARE_SERIALIZER(ADirectionalLight) \
	/** Indicates whether the class is compiled into the engine */    enum {IsIntrinsic=COMPILED_IN_INTRINSIC}; \
	virtual UObject* _getUObject() const override { return const_cast<ADirectionalLight*>(this); }
...
private: \
	...
	ENGINE_API ADirectionalLight(const ADirectionalLight& InCopy); \
public:
